...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { item_type: @wishlist.item_type, name: @wishlist.name, other: @wishlist.other } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { item_type: @wishlist.item_type, name: @wishlist.name, other: @wishlist.other } }
