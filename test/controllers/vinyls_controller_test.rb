...
class VinylsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vinyl" do
    assert_difference('Vinyl.count') do
      post vinyls_url, params: { vinyl: { artist: @vinyl.artist, condition: @vinyl.condition, label: @vinyl.label, title: @vinyl.title, year: @vinyl.year } }
    end
  ...
  test "should update vinyl" do
    patch vinyl_url(@vinyl), params: { vinyl: { artist: @vinyl.artist, condition: @vinyl.condition, label: @vinyl.label, title: @vinyl.title, year: @vinyl.year } }
